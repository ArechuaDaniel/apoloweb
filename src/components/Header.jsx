      ...
      <div className=" text-white uppercase font-bold flex justify-between  h-24 items-center absolute w-full">
        ...
        <div className="w-2/3 ">
          ...
          <ul className="p-10 md:text-3xl   flex justify-between">
            <NavLink className='mr-2 hover:text-red-400' to='/apoloweb/'>Home</NavLink>
            <NavLink className='mr-2 hover:text-red-400' to='/apoloweb/quienes-somos'>Quienes somos</NavLink>
            <NavLink className='mr-2 hover:text-red-400' to='/apoloweb/contactanos'>Contáctanos</NavLink>
